...
Description:
    ...
    GUI for using pySlater command line utility from within the Flame application.

Menus:

    Flame Menu (the fish) > Slates... > pySlater

To Install:

    For all users, copy this repository to:
    /opt/Autodesk/shared/python

    For a specific user, copy this repository to:
...
class PySlaterWindow(object):
    ...
    def message_shell(info):                                                                
        ...
        print(" ".join([MESSAGE_PREFIX, info])) 
    ...
    def message_window(self, string):
        """Print message to the bottom section of the plugin main window."""
    ...
    def main_window(self):
        ...
        self.cancel_btn = FlameButton(
            "Cancel", cancel_button, self.window)
        ...
        self.output_template = FlameLineEdit(
            self.output_template_path, "normal", self.window)
